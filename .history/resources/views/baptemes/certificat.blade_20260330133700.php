            ...
            <div class="card">
                ...
                <div class="card-content">
                    <div class="institution-with-logo">
                        <img src="{{ asset('images/logo_sda.png') }}" alt="Logo Église Adventiste" class="institution-logo">
                    ...
                    <div class="line-block">
                        ...
                        <div>Par le Pasteur/Ancien: <span class="field-sm">{{ $bapteme->officiant ?? '____________________' }}</span></div>
                        <div>De l'Église Adventiste de <span class="field-sm">{{ $bapteme->egliseLocale?->nom ?? '____________________' }}</span></div>
                        <div>District de <span class="field-sm">{{ $bapteme->egliseLocale?->district?->nom ?? '____________________' }}</span></div>
