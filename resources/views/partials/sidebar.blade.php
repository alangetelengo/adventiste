...
<aside class="sidebar theme-sidebar fixed top-20 left-0 w-[250px] h-[calc(100vh-80px)] z-[998] flex flex-col overflow-hidden transition-all duration-300">
    <nav class="flex-1 py-5 px-4 overflow-y-auto overflow-x-hidden sidebar-nav-scroll">
        <ul class="space-y-1">
            ...
            <li>
                <a href="{{ route('baptemes.index') }}" class="flex items-center gap-3 px-5 py-3 rounded-xl text-white/85 hover:bg-[rgba(212,168,75,0.12)] hover:text-white transition-all border border-transparent hover:border-[rgba(212,168,75,0.15)] {{ request()->routeIs('baptemes.*') ? 'nav-link-active shadow-[0_0_20px_rgba(120,80,160,0.15)]' : '' }}">
            ...
            <li>
                ...
                @else
                <a href="{{ route('parametres.eglises.departements.index', auth()->user()->egliseLocale) }}" class="flex items-center gap-3 px-5 py-3 rounded-xl text-white/85 hover:bg-[rgba(212,168,75,0.12)] hover:text-white transition-all border border-transparent hover:border-[rgba(212,168,75,0.15)] {{ request()->routeIs('parametres.eglises.departements.*') ? 'nav-link-active shadow-[0_0_20px_rgba(120,80,160,0.15)]' : '' }}">
                    <span class="text-lg flex-shrink-0">📚</span>
                    <span class="nav-text">Départements</span>
                </a>
                @endif
            ...
            <li>
                <a href="{{ route('secretariat.rapports-membres.index') }}" class="flex items-center gap-3 px-5 py-3 rounded-xl text-white/85 hover:bg-[rgba(212,168,75,0.12)] hover:text-white transition-all border border-transparent hover:border-[rgba(212,168,75,0.15)] {{ request()->routeIs('secretariat.rapports-membres.*') ? 'nav-link-active shadow-[0_0_20px_rgba(120,80,160,0.15)]' : '' }}">
                    <span class="text-lg flex-shrink-0">🗂️</span>
            ...
            <li>
                <a href="{{ route('finances.etat-dimes-eglises.index') }}" class="flex items-center gap-3 px-5 py-3 rounded-xl text-white/85 hover:bg-[rgba(212,168,75,0.12)] hover:text-white transition-all border border-transparent hover:border-[rgba(212,168,75,0.15)] {{ request()->routeIs('finances.etat-dimes-eglises.*') ? 'nav-link-active shadow-[0_0_20px_rgba(120,80,160,0.15)]' : '' }}">
                    <span class="text-lg shrink-0">🧾</span>
                    <span class="nav-text">État des dîmes</span>
                </a>
            </li>
            <li>
                <a href="{{ route('finances.synthese-annuelle-mission.index') }}" class="flex items-center gap-3 px-5 py-3 rounded-xl text-white/85 hover:bg-[rgba(212,168,75,0.12)] hover:text-white transition-all border border-transparent hover:border-[rgba(212,168,75,0.15)] {{ request()->routeIs('finances.synthese-annuelle-mission.*') ? 'nav-link-active shadow-[0_0_20px_rgba(120,80,160,0.15)]' : '' }}">
                    <span class="text-lg shrink-0">📒</span>
