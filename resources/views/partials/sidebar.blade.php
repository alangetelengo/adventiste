@php
    ...
    $navActive = 'nav-link-active shadow-[0_0_20px_rgba(120,80,160,0.15)]';
@endphp
...
<aside class="sidebar theme-sidebar fixed top-20 left-0 w-[250px] h-[calc(100vh-80px)] z-[998] flex flex-col overflow-hidden transition-all duration-300">
    <nav class="flex-1 py-5 px-4 overflow-y-auto overflow-x-hidden sidebar-nav-scroll">
        <ul class="space-y-1">
            ...
            @endcan
            @if(auth()->user()->voitMenuRapportsMensuelsFinances() && auth()->user()->can('viewAny', App\Models\RapportMensuelEglise::class))
            <li>
            ...
            @can('ventilationModule', App\Models\MissionTresorerieRapportMensuel::class)
            <li>
