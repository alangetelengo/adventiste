...
@section('page-title', 'Synthèse annuelle trésorerie mission')

@section('page-title-info')
État synthétique des dîmes, offrandes, revenus et transferts — année {{ $annee }}
@endsection
...
<div class="adventiste-card-pro-static mb-5 p-5 sm:p-6">
    <form method="get" action="{{ route('finances.synthese-annuelle-mission.index') }}" class="flex flex-wrap items-end gap-4">
        ...
        <button type="submit" class="rounded-lg bg-emerald-700 text-white px-5 py-2.5 text-sm font-medium hover:bg-emerald-800">Afficher</button>
    </form>
</div>
        ...
        <table class="w-full text-sm min-w-[1500px]">
            <thead>
                <tr class="border-b-2 border-slate-300 dark:border-slate-600 bg-slate-100/90 dark:bg-slate-700/80">
                    <th class="px-3 py-3 text-left text-xs font-bold uppercase text-slate-700 dark:text-slate-200">CONGO</th>
                    ...
                    @endforeach
                    <th class="px-3 py-3 text-right text-xs font-bold uppercase text-slate-700 dark:text-slate-200">Total</th>
                </tr>
            </thead>
            <tbody class="divide-y divide-slate-100 dark:divide-slate-700/80">
                <tr class="bg-slate-50/80 dark:bg-slate-900/30 font-semibold">
                    <td colspan="14" class="px-3 py-2">État synthétique des dîmes et des offrandes</td>
                </tr>
                <tr>
                    <td class="px-3 py-2.5 font-medium">Dîmes</td>
                ...
                <tr>
                    <td class="px-3 py-2.5 font-medium">Offrandes</td>
                ...
                <tr class="bg-slate-50/80 dark:bg-slate-900/30 font-semibold">
                    <td class="px-3 py-2.5">Total Di+Off</td>
                ...
                <tr>
                    <td class="px-3 py-2.5 font-medium">% Offr. / Dîmes</td>
                ...
                <tr class="bg-slate-100/90 dark:bg-slate-700/70 font-semibold">
                    <td colspan="14" class="px-3 py-2">Revenus</td>
                </tr>
                <tr>
                    <td class="px-3 py-2.5 font-medium">Dîmes (69%)</td>
                ...
                <tr>
                    <td class="px-3 py-2.5 font-medium">Offrandes (20%)</td>
                ...
                <tr>
                    <td class="px-3 py-2.5 font-medium">Autres offr.</td>
                ...
                <tr class="bg-slate-50/80 dark:bg-slate-900/30 font-semibold">
                    <td class="px-3 py-2.5">Total revenus</td>
    ...
    @endif
        <div class="overflow-x-auto">
            <table class="w-full text-sm min-w-[1700px]">
                <thead>
                    <tr class="border-b-2 border-slate-300 dark:border-slate-600 bg-slate-100/90 dark:bg-slate-700/80">
                        <th class="px-3 py-3 text-left text-xs font-bold uppercase text-slate-700 dark:text-slate-200">État du transfert de fonds en dépôt</th>
                        @foreach ($nomsMois as $nomMois)
                        <th class="px-3 py-3 text-right text-xs font-bold uppercase text-slate-700 dark:text-slate-200">{{ $nomMois }}-{{ substr((string) $annee, -2) }}</th>
                        @endforeach
                        <th class="px-3 py-3 text-right text-xs font-bold uppercase text-slate-700 dark:text-slate-200">Total</th>
                ...
                <tbody class="divide-y divide-slate-100 dark:divide-slate-700/80">
                    <tr>
                        <td class="px-3 py-2.5 font-medium">%tage dîmes (31%)</td>
                    ...
                    <tr>
                        <td class="px-3 py-2.5 font-medium">%tage offr. (30%)</td>
                    ...
                    <tr class="bg-slate-50/80 dark:bg-slate-900/30 font-semibold">
                        <td class="px-3 py-2.5">Total à transférer</td>
                    ...
                    <tr class="bg-yellow-100/80 dark:bg-yellow-900/30">
                        <td class="px-3 py-2.5 font-semibold">Transf. Bank. effectué</td>
                    ...
                    <tr>
                        <td class="px-3 py-2.5 font-medium">Différence sur transfert</td>
                        @foreach ($keysMois as $m)
                    ...
                    <tr>
                        <td class="px-3 py-2.5 font-medium">Observations transferts</td>
                        @foreach ($keysMois as $m)
        ...
        <div class="p-4 border-t border-slate-200 dark:border-slate-700 flex gap-3">
            <button type="submit" class="rounded-lg bg-emerald-700 text-white px-5 py-2.5 text-sm font-medium hover:bg-emerald-800">Enregistrer les transferts</button>
        </div>
        @endif
    @if ($peutSaisir)
    </form>
