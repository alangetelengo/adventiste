...
@section('content')
    <div class="max-w-xl rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 shadow-sm p-6">
        ...
        <form method="post" action="{{ route('finances.rapports-mensuels.store') }}" class="space-y-5">
            @csrf
