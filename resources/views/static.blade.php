...
@section('content')
    <div class="adventiste-card-pro-static max-w-2xl p-8 sm:p-10 text-center">
        <div class="mx-auto flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-emerald-500/15 to-violet-500/15 border border-emerald-500/20 text-emerald-700 dark:text-emerald-400 mb-6">
